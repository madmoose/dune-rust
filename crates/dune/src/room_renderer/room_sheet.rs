        ...
        for ofs in room_offsets {
            ...
            loop {
                ...
                if (cmd & 0x8000) == 0 {
                    ...
                    let start_x = r.read_le_u16()? as i16;
                    let start_y = r.read_le_u16()? as i16;
                    ...
                    loop {
                        x = r.read_le_u16()? as i16;
                        y = r.read_le_u16()? as i16;
                    ...
                    // Line
                    let p0 = (r.read_le_u16()? as i16, r.read_le_u16()? as i16);
                    let p1 = (r.read_le_u16()? as i16, r.read_le_u16()? as i16);
